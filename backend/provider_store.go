...
func NewProviderStore() *ProviderStore {
	return &ProviderStore{providers:map[string]DNSProvider{
		"ftn": {ID:"ftn", Name:"FTN", Kind:"authoritative", Enabled:true, ReadOnly:false},
		"cloudflare": {ID:"cloudflare", Name:"Cloudflare", Kind:"authoritative", Enabled:true, ReadOnly:true},
	}}
}
