...
func ActionCatalog() []ActionDefinition { return []ActionDefinition{
 {Kind:"device.health",Capability:"monitoring",Risk:"low"},{Kind:"device.snapshot",Capability:"monitoring",Risk:"low"},{Kind:"network.latency",Capability:"monitoring",Risk:"low"},{Kind:"network.route",Capability:"monitoring",Risk:"low"},{Kind:"dns.query",Capability:"dns_mesh",Risk:"low"},{Kind:"dns.validate",Capability:"dns_mesh",Risk:"low"},{Kind:"ddns.validate",Capability:"dns_mesh",Risk:"low"},{Kind:"provider.health",Capability:"providers",Risk:"low"},{Kind:"provider.zone.list",Capability:"providers",Risk:"low"},{Kind:"provider.dns.records.list",Capability:"providers",Risk:"low"},{Kind:"provider.dns.record.upsert",Capability:"providers",Risk:"high",ApprovalRequired:true},{Kind:"provider.dns.record.delete",Capability:"providers",Risk:"critical",ApprovalRequired:true},{Kind:"provider.zone.create",Capability:"providers",Risk:"high",ApprovalRequired:true},{Kind:"provider.zone.delete",Capability:"providers",Risk:"critical",ApprovalRequired:true},{Kind:"database.health",Capability:"database",Risk:"low"},{Kind:"monitoring.refresh",Capability:"monitoring",Risk:"low"},
} }
func (e *ActionExecutor) Execute(ctx context.Context, action WebAction) WebAction { return e.execute(ctx,action,false) }
func (e *ActionExecutor) ExecuteApproved(ctx context.Context, action WebAction) WebAction { return e.execute(ctx,action,true) }
func (e *ActionExecutor) execute(ctx context.Context, action WebAction, approved bool) WebAction {
 ...
 if def.ApprovalRequired && !approved { action.Status="pending_approval"; e.record(action,"pending_approval","approval required before execution"); return action }
